...
export default function Shop() {
  ...
  // This means that instead of nesting the useEffect() calls inside an if statement,
  // we can use dependency arrays to call the useEffect() when needed, and nest any
  // if statements or checks inside the hook when it is called
